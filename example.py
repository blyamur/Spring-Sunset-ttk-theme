...
Source: https://github.com/blyamur/Spring-Sunset-ttk-theme/
...
class App(ttk.Frame):
    ...
    def setup_widgets(self):
        ...
        # Switch
        self.switch = ttk.Checkbutton(
            self.widgets_frame, text="Switch disabled", style="Switch.TCheckbutton",state="disabled"
        )
        self.switch.grid(row=10, column=0, padx=5, pady=10, sticky="w")
        ...
        self.label = ttk.Label(
            self.tab_1,
            text="Spring Noon theme for ttk",
            justify="center",
...
if __name__ == "__main__":
    ...
    root.tk.call("source", "spring-sunset.tcl")
