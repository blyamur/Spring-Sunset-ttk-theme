...
namespace eval ttk::theme::spring-sunset-light {
    variable version 1.0
    package provide ttk::theme::spring-sunset-light $version

    ttk::style theme create spring-sunset-light -parent clam -settings {
        ...
        # Button
        ttk::style configure TButton -padding {8 4} -anchor center -foreground $colors(-bg)

        ttk::style map TButton -foreground \
            [list disabled #424242 \
                pressed #424242 \
                active #424242]
        ...
        # Menubutton
        ttk::style configure TMenubutton -padding {8 4 0 4} -foreground $colors(-bg)
        ...
        # Accent.TButton
        ttk::style configure Accent.TButton -padding {8 4} -anchor center -foreground #271C2D

        ttk::style map Accent.TButton -foreground \
            [list disabled #271C2D \
                pressed #FFF]
        ...
        # Toggle.TButton
        ttk::style configure Toggle.TButton -padding {8 4 8 4} -anchor center -foreground $colors(-bg)

        ttk::style map Toggle.TButton -foreground \
            [list {selected disabled} #271C2D \
                {selected pressed} #271C2D \
                selected #271C2D \
                pressed #271C2D \
                disabled #271C2D \
                active #271C2D
        ...
        # Entry
        ttk::style configure TEntry -foreground $colors(-bg)
        ...
        # Combobox
        ttk::style configure TCombobox -foreground $colors(-bg)
        ...
        # Spinbox
        ttk::style configure TSpinbox -foreground $colors(-bg)
